...
#{'code': URLError(ConnectionRefusedError(111, 'Connection refused'),), 'msg': '请求api数据错误！', 'redirect_url': '', 'result': URLError(ConnectionRefusedError(111, 'Connection refused'),), 'data': '{}'}

    print("article_data:",article_data)
    article_list = article_data["results"]  #result
    user = []
...
def category(request):
    ...
    ul = "http://127.0.0.1:8090/categoryitems/"
    print(ul)
    print(data)

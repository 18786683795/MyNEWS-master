...
SECRET_KEY = '^%3=hio2uf+omtbx$=x(6$g-^0m&pxf1a+13w0po98p32v2mjo'
...
#    ),
    'DEFAULT_SCHEMA_CLASS': 'rest_framework.schemas.coreapi.AutoSchema',  #xadmin后台管理系统
}
